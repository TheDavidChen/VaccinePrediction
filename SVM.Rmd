...
#Tuning
set.seed(1)
tune.out <-  tune(svm,  h1n1_vaccine~ ., data = model_train, kernel = "linear", ranges = list(cost =c(0.01, 0.05, 0.1, 0.5,  1, 5, 10)))
summary(tune.out)
svc.fit <- svm(h1n1_vaccine~., data=model_train,kernel="linear",cost=) #cost will be set to the best parameter given
train.pred <- predict(svc.fit, model_train)
table(model_train$h1n1_vaccine,train.pred)
#prediction rate
test.pred <- predict(svc.fit, model_test)
...
#Tuning
set.seed(1)
tune.out <-  tune(svm,  h1n1_vaccine~ ., data = model_train, kernel = "radial", ranges = list(cost =c(0.01, 0.05, 0.1, 0.5,  1, 5, 10)))
summary(tune.out)
svm.fit <- svm(h1n1_vaccine~.,data=model_train, kernel="radial", cost=) #same as above
train.pred <-  predict(svm.fit, model_train)
table(model_train$h1n1_vaccine, train.pred)
#prediction rate
test.pred <- predict(svm.fit, model_test)
...
#Tuning
set.seed(1)
tune.out <-  tune(svm,  h1n1_vaccine~ ., data = model_train, kernel = "poly", ranges = list(cost =c(0.01, 0.05, 0.1, 0.5,  1, 5, 10)))
summary(tune.out)
svm.fit <- svm(h1n1_vaccine~.,data=model_train, kernel="poly", cost=) #same as above
train.pred <-  predict(svm.fit, model_train)
table(model_train$h1n1_vaccine, train.pred)
#prediction rate
test.pred <- predict(svm.fit, model_test)
...
#Tuning
set.seed(1)
tune.out <-  tune(svm,  seasonal_vaccine~ ., data = model_train, kernel = "linear", ranges = list(cost =c(0.01, 0.05, 0.1, 0.5,  1, 5, 10)))
summary(tune.out)
svc.fit <- svm(seasonal_vaccine~., data=model_train,kernel="linear",cost=) #cost will be set to the best parameter given
train.pred <- predict(svc.fit, model_train)
table(model_train$seasonal_vaccine,train.pred)
#prediction rate
test.pred <- predict(svc.fit, model_test)
...
#Tuning
set.seed(1)
tune.out <-  tune(svm,  seasonal_vaccine~ ., data = model_train, kernel = "radial", ranges = list(cost =c(0.01, 0.05, 0.1, 0.5,  1, 5, 10)))
summary(tune.out)
svm.fit <- svm(seasonal_vaccine~.,data=model_train, kernel="radial", cost=) #same as above
train.pred <-  predict(svm.fit, model_train)
table(model_train$seasonal_vaccine, train.pred)
#prediction rate
test.pred <- predict(svm.fit, model_test)
...
#Tuning
set.seed(1)
tune.out <-  tune(svm,  seasonal_vaccine~ ., data = model_train, kernel = "poly", ranges = list(cost =c(0.01, 0.05, 0.1, 0.5,  1, 5, 10)))
summary(tune.out)
svm.fit <- svm(seasonal_vaccine~.,data=model_train, kernel="poly", cost=) #same as above
train.pred <-  predict(svm.fit, model_train)
table(model_train$seasonal_vaccine, train.pred)
#prediction rate
test.pred <- predict(svm.fit, model_test)
