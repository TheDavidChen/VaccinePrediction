...
Raw_labels <- read.csv("./Data/training_set_labels.csv", stringsAsFactors=FALSE)
...
Check the total number of NAs for each row. Note that for some columns, there is just a blank value instead of NA (employment_industry/occupation). This is not entirely representative.
