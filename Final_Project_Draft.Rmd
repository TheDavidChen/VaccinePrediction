...
For this project, we are working with seasonal flu and swine flu (H1N1) vaccination data provided through drivendata.org (link in Appendix). We are interested in creating models to predict seasonal flu and swine flu vaccinations. We are exploring the usefulness of various modeling techniques we have learned throughout the semester in tackling this classification problem. For the purposes of this project, we will only use the training data provided in the website, which consists of 26707 observations of 36 variables. We first load the necessary libraries, data set, and global options.
...
```{r, fig.height=2,fig.align = 'center', fig.cap="Histogram of the combined behaviors"}
...
Overall, our analysis provides a great stepping stone to determining how we can improve vaccination rates and thus protect the general population from contagious virus diseases.
